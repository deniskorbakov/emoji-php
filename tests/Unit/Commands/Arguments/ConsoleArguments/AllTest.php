...
test('success - all returns all arguments', function () {
    $args = ['arg1', 'arg2', 'arg3'];
...
test('success - all returns empty array when no arguments', function () {
    $arguments = new ConsoleArguments([]);

    expect($arguments->all())->toBe([]);
});

test('success - all returns exact same array that was passed', function () {
